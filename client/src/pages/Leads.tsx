...
import { Search, Plus, Download, Edit2, Trash2, Filter, ChevronLeft, ChevronRight, X, Eye } from 'lucide-react';
...
export const Leads = () => {
  ...
  return (
    <div className="p-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 shadow-sm hover:shadow-md"
          >
            <Download size={18} />
            Export CSV
          </button>
          {isAdmin && (
            <button 
              onClick={() => openModal()}
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary-600 to-primary-500 text-white rounded-xl hover:from-primary-700 hover:to-primary-600 transition-all duration-300 shadow-lg shadow-primary-500/30 hover:shadow-primary-500/50 hover:-translate-y-0.5"
            >
              <Plus size={18} />
              Add Lead
            </button>
      ...
      <div className="glass p-5 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 mb-6 flex flex-col lg:flex-row gap-4 shadow-sm">
        <div className="flex-1 relative">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-gray-50/50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-300"
          />
        </div>
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <select 
              ...
              className="bg-gray-50/50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-300"
            >
      ...
      <div className="glass rounded-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden shadow-xl shadow-gray-200/20 dark:shadow-none">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50/80 dark:bg-gray-800/80 border-b border-gray-200/80 dark:border-gray-700/80 text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider">
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-8 text-center text-red-500">Failed to load leads.</td>
                </tr>
              ) : data?.data.length === 0 ? (
                <tr>
                ...
                data?.data.map((lead) => (
                  <tr key={lead._id} className="group hover:bg-primary-50/50 dark:hover:bg-gray-800/50 transition-all duration-200">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-right">
                      <Link 
                        to={`/leads/${lead._id}`}
                        className="text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 p-1 transition-colors mr-2 inline-block"
                      >
                        <Eye size={16} />
                      </Link>
                      {isAdmin && (
